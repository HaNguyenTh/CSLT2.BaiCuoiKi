...
{
    public partial class frmBCHDB_TheoNam_ : Form
    {
        public frmBCHDB_TheoNam_()
        {
            InitializeComponent();
        }
        ...
        private void btnBaocao_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C2:E2"].Value = "Danh sách Hóa Đơn Bán Theo "+ nam +"";

            //Lấy thông tin hóa đơn
            sql = "SELECT a.Ma_HDB,b.Ma_mayVT,b.Ten_mayVT,b.Thoi_han_BH,a.So_luong,a.Thanh_tien FROM tblChitietHDB as a, dboMay_vi_tinh as b,tblHDB as c WHERE a.Ma_mayVT=b.Ma_mayVT and a.Ma_HDB = c.Ma_HDB AND (YEAR(c.NgayBan)=" + txtNam.Text + ")";
